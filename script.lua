...
local function EKBNYI_fake_script() --orta 1.LocalScript 
    ...
    script.Parent.MouseButton1Down:Connect(function()
       ...
       Infinite.Text = "GodMode[Use In Fight] [ON]"
       script.Parent.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
       script.Parent.Size = UDim2.new(0, 155, 0, 55)
       script.Parent.TextColor3 = Color3.fromRGB(0,0,0)
       wait(.1)
       ...
       script.Parent.TextColor3 = Color3.fromRGB(255,255,255)
       if click ~= 2 then
           Character:FindFirstChildOfClass('Humanoid').HipHeight = 23
        else
            Character:FindFirstChildOfClass('Humanoid').HipHeight = 2
            Infinite.Text = "GodMode[Use In Fight]"
        end
    end)
end
